...
export const ORDER_PRICED_REQUEST = "ORDER_PRICED_REQUEST";
export const ORDER_PRICED_SUCCESS = "ORDER_PRICED_SUCCESS";
export const ORDER_PRICED_FAIL = "ORDER_PRICED_FAIL";
export const ORDER_PRICED_RESET = "ORDER_PRICED_RESET";
